<template>
    <div class="w-full">
      <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl text-gray-500 uppercase">My Watchlist TV Shows</h1>
...
export default {
  ...
  methods: {
    async fetchWatchlist() {
      try {
        const response = await axios.get('https://api.themoviedb.org/3/account/17353149/watchlist/tv', {
          params: {
